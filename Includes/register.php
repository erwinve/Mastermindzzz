            ...
            <div class="card-body">
              <form class="form" action="PHP/registerhandler.php" role="form" autocomplete="off" id="formLogin" novalidate="" method="POST">
                ...
                <div class="form-group">
                  ...
                  <div class="invalid-feedback">Voer je email adres in.
                  </div>
                </div>
                <div class="logbtns">
                  <button type="submit" class="btn btn-primary btn-lg" name="submit" id="submit">Register
                  </button>
                  <a href="index.php" class="btn btn-primary btn-lg">Login
                  </a>
                </div>
              </form>
            </div>
